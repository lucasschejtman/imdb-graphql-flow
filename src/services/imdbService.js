...
import { trace, fetch, resolve, promiseAll } from '../utils/curry';

import { compose, curry, map, prop, chain,
...
const searchOmdbUrl   = curry((id: string): RequestOptions => ({ uri: `http://www.omdbapi.com?i=${id}`, json: true }));
